...
/**
 * This interface defines callbacks methods that will be notified for all registered
 * BasicPlayerListener of BasicPlayer.
 */
public interface BasicPlayerListener {
   ...
   * channels, number of frames, vbr flag, id3v2/id3v1 (for MP3 only), comments (for Ogg Vorbis),
   * ...
   *
   ...
   */
  void progress(int bytesread, long microseconds, byte[] pcmdata, Map properties);
